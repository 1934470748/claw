  ...
  function injectBranding() {
    ...
    function applyLogo() {
      ...
      textNodes.forEach(function (el) {
        if ((el.textContent || "").trim() !== "ClawHouse" && (el.textContent || "").trim() !== "MianClaw") return;
      ...
      var welcome = Array.prototype.find.call(document.querySelectorAll("div,section,main"), function (el) {
        return (el.textContent || "").indexOf("WELCOME TO CLAWHOUSE") >= 0 || (el.textContent || "").indexOf("WELCOME TO MIANCLAW") >= 0;
      });
